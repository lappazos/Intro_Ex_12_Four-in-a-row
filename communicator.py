...
# DESCRIPTION : Contains Communicator Class
###########################################################################
...
class Communicator:
    ...
    # low value to create a connection "chance" (will not happen if simply set
    # to non blocking), but without interfering the mainloop flow.
